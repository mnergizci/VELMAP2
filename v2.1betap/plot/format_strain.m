function [strainmap,digrid,ssgrid,msgrid,i2grid] = format_strain(strain,meshspacing)
%=================================================================
% format_strain.m
...
msinterp = scatteredInterpolant(strainmap.lon,strainmap.lat,strainmap.dilat,'linear','none');
digrid = msinterp(longrid,latgrid);
