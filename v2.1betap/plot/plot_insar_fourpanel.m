...
png_asc = fullfile(outdir, [base '_asc4panel.png']);
png_dsc = fullfile(outdir, [base '_dsc4panel.png']);

make_panel_figure(x, y, refmap, datamap, ratemap, resimap, ...
...
function make_panel_figure(x, y, refmap, datamap, ratemap, resimap, ...
    insarboundary, pass_idx, clim_pass, borders, places, cmap, lonlim, latlim, ...
    title_pass, outfile)

    figure('Units','Normalized','OuterPosition',[0.22,0.22,0.52,0.52]);
